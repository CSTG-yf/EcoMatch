#!/usr/bin/env python3
"""Contract tests for the immutable official database import package (v2.0.3).

The package lives in evaluation/bank_nl2sql/db/releases/2.0.3/ and is a frozen,
Git-tracked companion for the official Bank NL2SQL v2.0.3 release. It is NOT a
...
RELEASE_DIR = DB_DIR / "releases" / "2.0.3"
...
EXPECTED_OFFICIAL_VERSION = "2.0.3"
